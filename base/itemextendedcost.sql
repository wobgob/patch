...
-- Dumping structure for table dbc.itemextendedcost
DROP TABLE IF EXISTS `itemextendedcost`;
CREATE TABLE IF NOT EXISTS `itemextendedcost` (
  `id` int unsigned NOT NULL DEFAULT '0',
  `costHonour` int unsigned NOT NULL DEFAULT '0',
  `costArena` int unsigned NOT NULL DEFAULT '0',
  ...
  `personalRating` int unsigned NOT NULL DEFAULT '0',
  `purchaseGroup` int unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8;

-- Dumping data for table dbc.itemextendedcost: ~974 rows (approximately)
INSERT INTO `itemextendedcost` (`id`, `costHonour`, `costArena`, `unknown1`, `requiredItem1`, `requiredItem2`, `requiredItem3`, `requiredItem4`, `requiredItem5`, `requiredItemCount1`, `requiredItemCount2`, `requiredItemCount3`, `requiredItemCount4`, `requiredItemCount5`, `personalRating`, `purchaseGroup`) VALUES
	...
	(2998, 0, 0, 0, 37711, 0, 0, 0, 0, 160, 0, 0, 0, 0, 0, 0),
	(2999, 0, 0, 0, 37711, 0, 0, 0, 0, 1600, 0, 0, 0, 0, 0, 0);
